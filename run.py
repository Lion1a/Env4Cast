...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='Env4Cast',
                        help='model name, options: [Env4Cast]')
    ...
    # parser.add_argument('--num_nodes', type=int, default=862)
    ...
    # parser.add_argument('--patch_size_list', nargs='+', type=int, default=[16,4,8,32,16,8,2,4,8,16,4,2])
    # parser.add_argument('--patch_size_list', nargs='+', type=int, default=[3, 1, 3 ,2, 1, 3, 2 ,1, 3,2,1,2])
    parser.add_argument('--patch_size_list', nargs='+', type=int, default=[3, 1, 6 ,2, 3, 1, 4 ,6, 4,3,6,2])
    ...
    print(f"详细运行时间: {int(hours):0>2}小时 {int(minutes):0>2}分 {seconds:05.2f}秒")